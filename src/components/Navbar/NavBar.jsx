...
const NavBar = () => {
  return (
    <nav  className="navbar animate__animated animate__backInDown d-flex flex-row flex-wrap justify-content-between mx-3">
        <div className="navbar_sections d-flex flex-wrap">
        ...
        <div className="navbar_social">
            <ul className='navbar_social_list d-flex flex-wrap'>
                    <li className='mx-2 my-2'>
                        <a href="https://www.linkedin.com/in/alejandro-gimeno-ataz-3741a013b/"><img src={Linkedin} alt="logo_linkedin" /></a>
                    </li>
                    <li className='mx-2 my-2'>
                        <a href="https://www.twitter.com"><img src={Twitter} alt="logo_twitter" /></a>
                    </li>
                    <li className='mx-2 my-2'>
