...
const AboutMe = () => {
  ...
  const tick = () => {
    ...
    let updatedText = isDeleting
      ? skill.substring(0, text.length - 1)
      : skill.substring(0, text.length + 1);
  ...
  return (
    ...
    >
      <div
        className={`about_container_arrow ${
          isLoaded ? "animation" : ""
      ...
      <div className="aboutMe_container d-flex flex-column justify-content-center align-self-center">
        ...
        <div className="aboutMe_container_box banner_model d-flex flex-column text-center justify-content-center animate__animated animate__fadeInTopLeft">
          ...
          <div className="aboutMe_container_box_text">
            <p>
              I personally consider myself a sincere and hardworking person. I
              try to do 100% of my work in all my tasks no matter what the work
              environment is or need help to anyone. In the opposite case I have
              no problem asking.
            </p>
            <p>
              I discovered my passion for programming throughout my degree
              studies and completed my projects. With all of this I decided to
              dedicate myself to this profession and make my living. Due to
              this, I find myself training in a self-taught way in all the
              technologies that I consider necessary.
            </p>
          </div>
        </div>
      </div>
